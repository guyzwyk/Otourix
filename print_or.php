...
<?php
	...
	$currentPage	=	'print_or.php';
	$tabOrientation	=	$myMember->get_orientation($_REQUEST['orientationId']);
?>
<!DOCTYPE html>
<!-- HTML5 Boilerplate -->
...
<html>
	<head>
		...
		<title>CSAO :: Espace membre - Imprimer / Impression d'un article d'Orientation</title>
	</head>
	<body>
	...
	<div id="print_page">
		...
		<div id="print_header_right">
			...
			<strong>Conseiller :</strong>&nbsp;<?php print $myMember->get_member_name_by_id($tabOrientation['or_USRID'])?><br />
			<strong>Date de mise en ligne :</strong>&nbsp;<?php print $myMember->datetime_fr2($tabOrientation['or_DATE']); ?></p>
		</div>
		<div style="clear:both;"></div>
		<div>
			<hr />
			<div id="print_title"><strong>Titre :</strong> <?php print $tabOrientation['or_TITLE'] ?></div>
			<div id="print_descr"><strong>Description :</strong> <?php print $tabOrientation['or_DESCR'] ?></div>
			<div id="print_content"><?php print $tabOrientation['or_CONTENT'] ?></div>
		</div>
	</div>
